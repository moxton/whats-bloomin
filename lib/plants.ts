...
export const PLANTS: Plant[] = [
  ...
  p("Lavender","Lavandula","perennial",[6,7,8],[5,6,7,8,9,10],["lavender","purple","blue"],["full-sun"],"low",["sandy","poor"],12,24,["pollinator","deer-resistant","low-maintenance","fragrant","cut-flower","container"],"Fragrant silver-green mounds beloved by bees and humans alike.",["Rose","Salvia","Catmint"]),
  ...
  p("Camellia","Camellia japonica","shrub",[11,12,1,2,3],[7,8,9,10],["pink","red","white"],["part-sun","part-shade"],"moderate",[],72,144,["deer-resistant","winter-interest","cut-flower"],"Glossy evergreen with rose-like blooms in the depths of winter.",["Hellebore","Witch Hazel","Snowdrop"]),
  ...
  p("Bougainvillea","Bougainvillea","vine",[3,4,5,6,7,8,9,10,11],[9,10],["pink","purple","red","orange","white"],["full-sun"],"low",["sandy","poor"],120,360,["low-maintenance"],"Explosive cascades of papery bracts. Covers walls and fences in color.",["Plumeria","Lantana","Bird of Paradise"]),
  ...
  // HERBS THAT FLOWER
  // =====================
  p("Rosemary","Salvia rosmarinus","perennial",[3,4,5],[7,8,9,10],["blue","lavender"],["full-sun"],"low",["sandy","poor"],24,48,["pollinator","fragrant","deer-resistant","container"],"Aromatic evergreen herb with tiny blue flowers loved by early bees. Needs excellent drainage.",["Lavender","Sage","Thyme"]),
