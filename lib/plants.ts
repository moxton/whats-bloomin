...
const PLANT_IMAGE_SLUGS = new Set([
  "aeonium","ajuga","allium","american-beautyberry","american-elderberry",
  "american-gold-rush-black-eyed-susan","anemone-de-caen","angel-s-trumpet","angelina-sedum",
  "anise-hyssop","annabelle-hydrangea","apeldoorn-tulip","apple","arnold-promise-witch-hazel",
  "aster","astilbe","aubrieta","autumn-joy-sedum","azalea","basket-of-gold","bee-balm",
  "beverly-sills-iris","bigtooth-maple","bird-of-paradise","black-eyed-susan","blanket-flower",
  "bleeding-heart","bloom-a-thon-azalea","bloomerang-lilac","blue-angel-hosta","blue-false-indigo",
  "blue-fescue","blue-flax","blue-grama-grass","blue-oat-grass","bobo-hydrangea","borage",
  "bottlebrush-buckeye","bougainvillea","bowl-of-beauty-peony","bridal-veil-astilbe","brunnera",
  "butterfly-bush","calibrachoa","california-fuchsia","california-lilac","california-poppy",
  "callery-pear","camassia","camellia","caradonna-salvia","cardinal-flower","cat-s-meow-catmint",
  "catmint","celosia","century-plant","chamomile","cheyenne-spirit-coneflower",
  "chicago-apache-daylily","chinese-witch-hazel","chives","chrysanthemum","clematis","cleome",
  "coleus","columbine","common-fig","compass-plant","coneflower","coral-aloe","coral-bean",
  "coral-bells","cosmos","crape-myrtle","creeping-phlox","creeping-thyme","crocosmia","crocus",
  "culinary-sage","daffodil","dahlia","daylily","delphinium","desert-marigold","dianthus","dogwood",
  "don-juan-climbing-rose","double-delight-rose","double-knock-out-rose","draba",
  "dragon-s-blood-sedum","drift-rose","dutch-iris","dwarf-korean-lilac","eastern-redbud",
  "echeveria","emily-mckenzie-crocosmia","empress-wu-hosta","encore-autumn-azalea",
  "endless-summer-hydrangea","epimedium","fanal-astilbe","festiva-maxima-peony","feverfew",
  "firecracker-penstemon","flowering-tobacco","forsythia","fountain-grass","foxglove","fringe-tree",
  "fritillaria","fruiting-cherry","garden-phlox","gardenia","globe-artichoke","glory-of-the-snow",
  "goatsbeard","golden-rain-tree","goldenrod","goldsturm-black-eyed-susan","graham-thomas-rose",
  "grape-hyacinth","gulf-coast-penstemon","halcyon-hosta","happy-returns-daylily",
  "hawaiian-hibiscus","hawthorn","helenium","hellebore","hens-and-chicks","hidcote-lavender",
  "highbush-blueberry","honeysuckle","hosta","hyacinth","hydrangea","ice-follies-daffodil",
  "ice-plant","immortality-iris","impatiens","incrediball-hydrangea","indian-paintbrush",
  "indian-summer-rudbeckia","iris","jack-in-the-pulpit","jackmanii-clematis","japanese-anemone",
  "japanese-forest-grass","japanese-iris","japanese-maple","japanese-painted-fern","jasmine",
  "joe-pye-weed","june-hosta","karl-foerster-feather-reed-grass","king-alfred-daffodil",
  "knock-out-rose","korean-lilac","lantana","lavender","lenten-rose","lewisia","liatris",
  "ligularia","lilac","limelight-hydrangea","little-bluestem","little-lime-hydrangea","lungwort",
  "lupine","magnolia","magnus-coneflower","mandevilla","manzanita","marigold","marsh-marigold",
  "matilija-poppy","may-night-salvia","meadow-rue","mexican-hat","meyer-lemon","miscanthus",
  "miss-kim-lilac","mock-orange","morning-glory","mountain-laurel","munstead-lavender",
  "nelly-moser-clematis","new-dawn-climbing-rose","nikko-blue-hydrangea","ninebark",
  "oakleaf-hydrangea","oregano","oregon-grape","ostrich-fern","pacific-bleeding-heart",
  "paperbark-maple","patriot-hosta","peach","pelargonium","penstemon","peony","persian-buttercup",
  "petunia","phenomenal-lavender","pickerelweed","pink-dipladenia","pink-muhly-grass",
  "pink-plumeria","pinky-winky-hydrangea","plumeria","pomegranate","powwow-wild-berry-coneflower",
  "prairie-dock","prairie-dropseed","prairifire-crabapple","purple-de-oro-daylily",
  "purple-prairie-clover","queen-of-night-tulip","quick-fire-hydrangea","red-twig-dogwood",
  "rhododendron","rhubarb","rocky-mountain-columbine","rocky-mountain-penstemon","rodgersia","rose",
  "rose-of-sharon","rosemary","russian-sage","sacred-lotus","salal","salvia",
  "sarah-bernhardt-peony","saxifrage","scarlet-sage","scilla","sea-thrift","sedum",
  "sensation-lilac","serviceberry","shasta-daisy","shooting-star","showy-goldenrod","smoke-tree",
  "snapdragon","snowdrop","solomon-s-seal","speedwell","spirea","stella-de-oro-daylily","stewartia",
  "sum-and-substance-hosta","sunflower","sweet-alyssum","sweet-autumn-clematis","sweet-olive",
  "sweet-pea","switchgrass","tall-verbena","texas-blue-star","thalia-daffodil","tickseed",
  "toad-lily","trillium","trumpet-gentian","trumpet-vine","tuberose","tulip","turtlehead",
  "viburnum","vinca","virginia-bluebell","visions-in-pink-astilbe","walker-s-low-catmint",
  "water-lily","wax-begonia","weigela","white-plumeria","white-swan-coneflower","wild-bergamot",
  "wild-geranium","winter-aconite","winter-daphne","winterberry","wintersweet","wisteria",
  "witch-hazel","wonderful-pomegranate","yarrow","yoshino-cherry","yucca","zinnia",
]);
